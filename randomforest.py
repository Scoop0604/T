...
def randomforest(dt,x_train, x_test, y_train, y_test):
...
def main(dat,x_train, x_test, y_train, y_test):
    y_pred1,mse1 = randomforest(dat,x_train, x_test, y_train, y_test)
    return y_pred1,mse1
